...
class Qwen2VLProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        if isinstance(images, list) and isinstance(images[0], Image.Image):
            ...
            raise ValueError(
                "Invalid input images. images must be a PIL image or a list of PIL images (images), or a list of list of PIL images (videos)."
            )
    ...
    def _call(
        ...
        **kwargs: Unpack[Qwen2VLProcessorKwargs],
        ...
        if images is not None:
            ...
            image_inputs = {}
        # if videos is not None and isinstance(videos[0], list
        ...
        text_inputs = self.tokenizer(
            text, add_special_tokens=False, **output_kwargs["text_kwargs"]
        )
