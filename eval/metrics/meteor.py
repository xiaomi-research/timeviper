...
class Meteor(object):
    ...
    def __init__(self, meteor_jar_path=None, java_jre_path=None, jdk_java_options=None):
        if java_jre_path:
        ...
        if meteor_jar_path:
            ...
            meteor_jar = os.path.join("./eval/metrics", "meteor-1.5.jar")  # NOTE
    ...
    def compute_score(self, gts, res):
        ...
        with self.lock:
            ...
            scores = [
                float(six.ensure_str(self.meteor_p.stdout.readline())) for _ in img_ids
            ]
    ...
    def _stat(
        self, img_ids, hypothesis_str, reference_list
        ...
        for i in img_ids:
            ...
            score_line = " ||| ".join(("SCORE", " ||| ".join(reference_list[i]), hypo))
